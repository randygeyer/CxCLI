 ...
 * 
 */
@WebService(name = "CxCLIWebServiceV1Soap", targetNamespace = "http://Checkmarx.com/v7")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CxCLIWebServiceV1Soap {
     ...
     */
    @WebMethod(operationName = "SsoLogin", action = "http://Checkmarx.com/v7/SsoLogin")
    @WebResult(name = "SsoLoginResult", targetNamespace = "http://Checkmarx.com/v7")
    @RequestWrapper(localName = "SsoLogin", targetNamespace = "http://Checkmarx.com/v7", className = "com.checkmarx.cxviewer.ws.generated.SsoLogin")
    @ResponseWrapper(localName = "SsoLoginResponse", targetNamespace = "http://Checkmarx.com/v7", className = "com.checkmarx.cxviewer.ws.generated.SsoLoginResponse")
    public CxWSResponseLoginData ssoLogin(
        @WebParam(name = "encryptedCredentials", targetNamespace = "http://Checkmarx.com/v7")
