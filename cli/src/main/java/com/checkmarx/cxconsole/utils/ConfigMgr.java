...
public class ConfigMgr {
    ...
    private ConfigMgr(String fileLocation) {
        applicationProperties = new Properties();
        loadProperties(fileLocation);
    }

    protected void loadProperties(String fileLocation) {
        try {
    ...
    public static ConfigMgr createCfgMgr(String fileLocation) {
        if (mgr == null) {
            mgr = new ConfigMgr(fileLocation);
        }
