...
public class Constants {
    ...
    public class ErrorMassages {
        ...
        public static final String THRESHOLD_PARAMETER_IN_ASYNC_SCAN = "Asynchronous run does not support thresholds. Please remove the threshold parameters and run again";
